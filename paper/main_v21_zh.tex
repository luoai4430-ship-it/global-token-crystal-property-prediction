...
\author[1]{臧怀娟}\ead{zanghj@hfut.edu.cn}
\author[1]{彭云帆}\cormark[1]
\author[2]{赵冲}\ead{zhaochong@hfut.edu.cn}
\author[1]{杨帆}\ead{2021800201@hfut.edu.cn}
\author[3]{洪峰}\ead{hongfeng@czu.edu.cn}
\author[1]{许良凤}\ead{xulfcjn@hfut.edu.cn}
\affiliation[1]{organization={合肥工业大学计算机与信息学院}, city={合肥}, country={中国}}
\affiliation[2]{organization={合肥工业大学工程素质教育中心}, city={合肥}, country={中国}}
\affiliation[3]{organization={池州学院}, city={池州}, country={中国}}
\cortext[1]{通讯作者：彭云帆}
...
\begin{figure}[pos=t]\centering\includegraphics[width=\linewidth]{overall_framework_v9_zh.pdf}
...
\begin{figure}[pos=t]\centering\includegraphics[width=\linewidth]{sftconv_architecture_zh.pdf}
...
\begin{figure}[pos=t]\centering\includegraphics[width=\linewidth]{attention_temperature_zh.pdf}
...
\begin{figure}[pos=H]\centering\includegraphics[width=\linewidth]{error_complementarity_zh.pdf}
...
\section*{资助声明}
本研究得到教育部产学合作协同育人项目（No.~250603873093026）、中央高校基本科研业务费专项资金（Grant No.~PA2025GDSK0036）以及电子信息科学与技术专业课程思政示范教学团队项目（No.~2025XKSTD01）的支持。
\section*{数据可用性}
